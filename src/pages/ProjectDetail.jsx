...
const ProjectDetail = () => {
  ...
  const projectsData = {
    "1": {
      ...
      area: '3,200 sq ft',
      duration: '3.5 Months',
      heroImg: 'https://res.cloudinary.com/dbmvjtbqk/image/upload/v1779111279/imresizer-2_rwnmyw.jpg',
      desc: 'A premium, custom-designed residential space tailored to the lifestyle of Mr. Abhi and his family. The project features elegant wall paneling, modular kitchen integration, and a sophisticated study unit. The design showcases our comprehensive end-to-end turnkey services, managing the timeline, vendor selection, and meticulous design execution smoothly.',
      gallery: [
        'https://res.cloudinary.com/dbmvjtbqk/image/upload/v1779111279/imresizer-2_rwnmyw.jpg',
        '/assets/projects/abhi/foyer.png',
        '/assets/projects/abhi/dining.png',
        '/assets/projects/abhi/kitchen.png',
        '/assets/projects/abhi/bedroom.png',
        '/assets/projects/abhi/bedroom_2.png',
        '/assets/projects/abhi/wardrobe.png',
        '/assets/projects/abhi/wardrobe_2.png',
        '/assets/projects/abhi/plan.png'
      ]
    },
    "4": {
  ...
  return (
    <div className="bg-white">
      <Helmet>
        <title>{project.title} | Orniva Design Studio</title>
        <meta name="description" content={project.desc.substring(0, 160)} />
      </Helmet>
      {/* Hero Image */}
      <section className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
        <img
          src={project.heroImg}
          alt={project.title}
          className="w-full h-full object-cover blur-[5px] scale-120"
        />
      ...
      {/* Next Project CTA */}
      <section className="py-24 bg-gradient-dark text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-heading font-bold text-[#111] mb-8">Ready to start your project?</h2>
          <Link to="/contact" className="px-8 py-4 bg-accent text-white rounded-full font-medium hover:bg-primary hover:text-white transition-colors inline-block">
            Get in Touch
          </Link>
        </div>
      </section>
